...
namespace RareParts
{
    public interface ITransferAllConfig
    {
        /// <summary>
        ...
        /// </summary>
        KeyCode SetPartConditionLower { get; }
    ...
    public class Config : ITransferAllConfig
    {
        ...
        private static string[] DefaultRetroParts1950_1959 = [
            ...
            // Note: many engines have common parts, in this case the latest part entry is applied.
        ...
        private static string[] DefaultRetroParts1970_1979 = [
            ...
            // BOLT REPTILIA (1970)
            "car_boltreptilia", "seat_reptiliar", "steering_wheel_reptiliar", "rim_reptiliar",
        ...
        private static string[] DefaultRetroParts1980_1990 = [
            ...
            "car_mercedes500e", "w_v8_m119_koncowy_500e", "w_v8_m119_poczatkowy_500e", "steering_wheel_500e",
            ...
            // ENGINE (R4)
            "r4_blok", "r4_gearbox_short", "r4_glowica_2", "r4_kolo_pasowe_walu", "r4_miska_olejowa", "r4_oslona",
        ...
        private static string[] DefaultRetroParts1991_2000 = [
            ...
            // SEAT and etc BELT
            "seat_cuda", "seat_gullwing", "seat_sec",
            "seat_charger",
            "seat_carreragt", "seat_964", "seat_991",
            "seat_chrysler_cordoba", "seat_300c", "seat_gw500", "seat_highroad",
        ...
        private readonly MelonPreferences_Entry<int> _priceParts1970_1979;
        private readonly MelonPreferences_Entry<int> _priceParts1980_1990;
        private readonly MelonPreferences_Entry<int> _priceParts1991_2000;
        private readonly MelonPreferences_Entry<int> _priceParts2001_2005;
        private readonly MelonPreferences_Entry<int> _pricePartsGT;
        private readonly MelonPreferences_Entry<int> _pricePartsSpecialRetro;
        private readonly MelonPreferences_Entry<int> _pricePartsOther;
        ...
        /// <summary>
        /// Warehouses to move Shopping List items to when using TransferAll.
        /// </summary>
        ...
        public int SetPartConditionLowerBy10()
        {
            if (MinPartCondition is 90 or 85)
            {
                MinPartCondition -= 5;
            }
            else
        ...
        public int SetPartConditionHigherBy10()
        {
            if (MinPartCondition is 80 or 85)
            {
                MinPartCondition += 5;
            }
            else
        ...
        public Config(string configFilePath)
        {
            ...
            // local functions
            MelonPreferences_Category CreateCategory(string categoryName)
            {
